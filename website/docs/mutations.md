...
Given this, RocketJump can create a full mutation workflow:
1. For each mutation, a special RocketJump action creator is created and injected in the actions creators
