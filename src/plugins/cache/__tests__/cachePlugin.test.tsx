...
import { RjObject } from '../../../core/types'

type TestCb = (...args: any[]) => Promise<any>

async function asyncForEach(array: any[], callback: TestCb) {
  for (let index = 0; index < array.length; index++) {
    await callback(array[index], index, array)
  }
}

const makeRjComponent = (rjState: RjObject) => {
